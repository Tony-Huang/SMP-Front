...
CREATE TABLE ROLES
   (id INT GENERATED BY DEFAULT AS IDENTITY,roleName_CN VARCHAR(20), roleName_EN VARCHAR(20), roleDesc_CN  VARCHAR(30), roleDesc_EN VARCHAR(30) ,
    PRIMARY KEY (id)
   );
   
CREATE TABLE USERS 
   (id INT GENERATED BY DEFAULT AS IDENTITY, userName VARCHAR2(50), password VARCHAR(128),roleId INT,
